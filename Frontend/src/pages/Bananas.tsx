    ...
    <div className="max-w-7xl mx-auto w-full">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center space-x-4 mt-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">{t("bananas")}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Restock Actions */}
          <div className="card rounded-xl shadow-lg h-80 p-4">
            <RestockActions produceName="Bananas" />
          </div>
        </div>
          ...
          <div className="card rounded-xl shadow-lg h-80 p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">{t("cavendish")}</span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">{t("oneHourAgo")}</span>
              </div>
            </div>
          </div>
