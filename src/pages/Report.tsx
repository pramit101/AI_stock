...
export default function Report() {
  ...
  const getTimeframeData = (product: Product) => {
    ...
    if (timeframe === "weekly") {
      return [
        { time: "Mon", value: currentStock },
        { time: "Tue", value: currentStock },
        { time: "Wed", value: currentStock },
        { time: "Thu", value: currentStock },
        { time: "Fri", value: currentStock },
        { time: "Sat", value: currentStock },
        { time: "Sun", value: currentStock },
      ];
    }
  ...
  const generateProductReport = (product: Product) => (
    <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl shadow-md space-y-6">
      ...
      <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow">
        <h4 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">Current Stock Level</h4>
        <div className="flex justify-between items-center mb-2">
          <span className="text-gray-600 dark:text-gray-400">Stock Percentage</span>
      ...
      <div className="bg-white dark:bg-gray-700 p-4 rounded-lg shadow">
        <h4 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">
          Stock History ({timeframe === "daily" ? "Daily" : timeframe === "weekly" ? "Weekly" : "Monthly"})
        </h4>
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={getTimeframeData(product)}>
