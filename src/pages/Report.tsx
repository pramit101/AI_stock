...
const productImages: { [key: string]: string } = {
  Banana: "https://images.unsplash.com/photo-1587334206596-c0f9f7dccbe6?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjR8fGJhbmFuYXxlbnwwfHwwfHx8MA%3D%3D",
  Apple: "https://images.unsplash.com/photo-1567306226416-28f0efdc88ce",
  Cucumber: "https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y3VjdW1iZXJ8ZW58MHx8MHx8fDA%3D",
...
export default function Report() {
  ...
  const handleReportClick = (name: string) => setSelectedReport(name);
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold text-purple-600">{product.stock}%</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg">
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        <TitleHeader toggleSidebar={handleCollapse} title="Reports" />
