    ...
    <div className="max-w-7xl mx-auto w-full">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Carrots</h1>
            <p className="text-gray-600 dark:text-gray-400">Fresh Orange Carrots - Inventory Management</p>
          </div>
        </div>
      </div>
          ...
          <div className="card rounded-xl shadow-lg h-80 p-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">Nantes</span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-gray-100">2-4 weeks</span>
              </div>
              
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Last Updated:</span>
                <span className="font-medium text-gray-900 dark:text-gray-100">4 hours ago</span>
              </div>
            </div>
          </div>
